...
vim.cmd [[
  ...
  autocmd FileType javascript :lua require('cmp').setup.buffer { enabled = false }
  ]]
vim.g.kite_supported_languages = {'python','javascript','go'}
...
local config = {
  ...
  polish = function()
    ...
    vim.keymap.set("n", "<F5>", ":ToggleTerm direction=float<cr>")
